...
<head>
    ...
    <!-- Datatable -->
    <link href="./admin_area/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
    <!-- Custom Stylesheet -->
	<link href="./admin_area/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="./admin_area/vendor/lightgallery/css/lightgallery.min.css" rel="stylesheet">
										...
										<div class="d-sm-flex mb-3">
											...
											<div class="card-info d-flex align-items-start">
												<div class="mr-auto pr-3">
													<h2 class="font-w600 mb-2 text-black">Le The Luc</h2>
											...
											<div class="col-sm-7 mb-sm-0 mb-3">
												<div class="d-flex">
													...
													<div>
														...
														<p class="fs-18 mb-0 text-black">795 Nguyen Trai <strong class="d-block">CADGE 94107</strong></p>
													</div>
												</div>
											</div>
											<div class="col-sm-5">
