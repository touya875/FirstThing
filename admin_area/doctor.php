							...
							<table id="example5" class="display dataTablesCard table-responsive-xl">
								...
								<tbody>
									<tr>
										...
										<td>Dentist</td>
										<td>
											<a href="javascript:void(0)" class="btn btn-primary text-nowrap btn-sm light">2 Patients</a>
										</td>
									...
									<tr>
										...
										<td>
											<a href="javascript:void(0)" class="btn btn-primary text-nowrap btn-sm light">3 Patients</a>
										</td>
										<td><span class="text-nowrap">+12 4124 5125</span></td>
										<td><span class="text-dark">Unavailable</span></td>
										<td>
									...
									<tr>
										...
										<td>Dentist</td>
										<td>
											<a href="javascript:void(0)" class="btn btn-outline-dark text-nowrap btn-sm">0 Patient</a>
										</td>
